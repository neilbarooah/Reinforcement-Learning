 ...
 *
 */
public class MyLearningAlgorithmExperimenter {
	 ...
	 */
	public MyLearningAlgorithmExperimenter(Environment testEnvironment, int nTrials, int trialLength, LearningAgentFactory...agentFactories){
