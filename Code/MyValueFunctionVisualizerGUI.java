 ...
 *
 */
public class MyValueFunctionVisualizerGUI extends JFrame implements ItemListener {
     ...
     */
    public static MyValueFunctionVisualizerGUI createGridWorldBasedValueFunctionVisualizerGUI(List <State> states, ValueFunction valueFunction, Policy p,
        ...
        MyValueFunctionVisualizerGUI gui = new MyValueFunctionVisualizerGUI(states, svp, valueFunction);
        gui.setSpp(spp);
        gui.setPolicy(p);
     ...
     * @param valueFunction the valueFunction that can return the state values.
     */
    public MyValueFunctionVisualizerGUI(List <State> states, StateValuePainter svp, ValueFunction valueFunction){
    ...
    public void initGUI(){
        ...
        this.showPolicy.setSelected(true);
        this.pLayer.setSpp(spp);
