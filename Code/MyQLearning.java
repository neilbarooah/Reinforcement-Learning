 ...
 *
 */
public class MyQLearning extends MDPSolver implements QFunction, LearningAgent, Planner{
	...
	public MyQLearning(Domain domain, double gamma, HashableStateFactory hashingFactory,
		...
		this.QLInit(domain, gamma, hashingFactory, new ValueFunctionInitialization.ConstantValueFunctionInitialization(qInit), learningRate, new EpsilonGreedy(this, epsilon), Integer.MAX_VALUE);
	}
	...
	public MyQLearning(Domain domain, double gamma, HashableStateFactory hashingFactory,
		...
		this.QLInit(domain, gamma, hashingFactory, new ValueFunctionInitialization.ConstantValueFunctionInitialization(qInit), learningRate, new EpsilonGreedy(this, epsilon), maxEpisodeSize);
	}
